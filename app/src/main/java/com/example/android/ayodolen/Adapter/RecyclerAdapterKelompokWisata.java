...
public class RecyclerAdapterKelompokWisata extends RecyclerView.Adapter<RecyclerAdapterKelompokWisata.MyViewHolder> implements Filterable {
    ...
    public RecyclerAdapterKelompokWisata(List<Wisata> wisata, Context mContext) {
        this.wisata = wisata;
    ...
    @NonNull
    @Override
    public RecyclerAdapterKelompokWisata.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View mView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_gview_wisata_kelompok, parent, false);
        MyViewHolder myViewHolder = new MyViewHolder(mView);
        return myViewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerAdapterKelompokWisata.MyViewHolder holder, final int position) {
