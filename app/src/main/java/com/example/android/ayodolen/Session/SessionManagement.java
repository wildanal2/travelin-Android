...
//        mEditor.putString(KEY_ID, id_user.toString());
    ...
    public void createSkipSession(Boolean skip){
        // Storing skip value as TRUE
        if(skip){
            mEditor.putBoolean(IS_SKIP, true);
        }else{
            mEditor.putBoolean(IS_SKIP, false);
        }
        mEditor.commit();
    }
    ...
    public boolean isSkiped(){
        return mSharedPreference.getBoolean(IS_SKIP, false);
    }
